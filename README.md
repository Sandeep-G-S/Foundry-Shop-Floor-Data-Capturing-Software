...
1. **.NET SDK** (Version `6.0` or later) → [Download](https://dotnet.microsoft.com/en-us/download)  
2. **Microsoft SQL Server** → [Download](https://www.microsoft.com/en-us/sql-server/sql-server-downloads)  
3. **SQL Server Management Studio (SSMS)** → [Download](https://aka.ms/ssmsfullsetup)  
4. **Visual Studio** (with `.NET & ASP.NET` workload installed)  
5. **Android Studio** (For running the Android app)  
6. **Postman** (Optional, for API testing) → [Download](https://www.postman.com/downloads/)  
...
2. Create a new database named: `FoundryDB`  
3. Run the provided SQL script (`database_script.sql`) to set up tables  
...
| **Login Screen** | **Dashboard** | **Data Entry** |
|-----------------|--------------|---------------|
| ![Login](screenshots/login.png) | ![Dashboard](screenshots/dashboard.png) | ![Data Entry](screenshots/data_entry.png) |
